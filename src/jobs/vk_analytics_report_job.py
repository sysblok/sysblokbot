...
class VkAnalyticsReportJob(BaseJob):
    ...
    def _execute(app_context: AppContext, send: Callable[[str], None], called_from_handler=False):
        ...
        message = load(
            ...
            total_posts_reach=_format_int(sum([post.reach_total for post in recent_posts_stats])),
            ...
            top_reach_post_link=top_reach_post_stats.post.stats_url,
            top_reach_post_name=top_reach_post_stats.post.get_registry_name(post_registry_items),
            top_reach_post_num=_format_int(top_reach_post_stats.reach_total),
            top_likes_post_link=top_likes_post.stats_url,
            top_likes_post_name=top_likes_post.get_registry_name(post_registry_items),
            top_likes_post_num=top_likes_post.likes,
            top_reposts_post_link=top_reposts_post.stats_url,
            top_reposts_post_name=top_reposts_post.get_registry_name(post_registry_items),
            top_reposts_post_num=top_reposts_post.reposts,
            top_comments_post_link=top_comments_post.stats_url,
            top_comments_post_name=top_comments_post.get_registry_name(post_registry_items),
