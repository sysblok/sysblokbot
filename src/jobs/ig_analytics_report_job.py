...
class IGAnalyticsReportJob(BaseJob):
    ...
    def _execute(
        ...
        message = load(
            ...
            new_posts=app_context.instagram_analytics.get_new_posts_count(
            ...
            # subscribed=-1,
            # unsubscribed=-1,
            total_reach=app_context.instagram_analytics.get_reach(
                week_ago, end_week_day
            ),
            # total_reach_delta=-1,
            ...
            likes_num=app_context.instagram_analytics.get_likes_count(
                week_ago, end_week_day
            ),
