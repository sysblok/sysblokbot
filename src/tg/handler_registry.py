...
from ...consts import CommandCategories, JobType, AccessLevel
...
class HandlerConfig:
    ...
    job_type: JobType = JobType.MANAGER_REPLY
...
HANDLER_REGISTRY = [
    ...
    HandlerConfig(
        ...
        job_type=JobType.ADMIN_BROADCAST,
    ...
    HandlerConfig(
        ...
        job_name="trello_board_state_job",
        job_type=JobType.MANAGER_REPLY,
