...
@direct_message_only
async def enroll_curator(update, tg_context):
    ...
    if curator:
        ...
        await reply(load("enroll_curator_handler__success"), update)
    else:
        await reply(load("enroll_curator_handler__not_found"), update)
