...
def handle_user_message(
    ...
    if next_action == PlainTextUserAction.GET_TASKS_REPORT__ENTER_BOARD_URL:
        ...
        try:
            ...
            reply(load('user_message_handler__board_not_found'), update)
            return
        ...
        reply(
            load('user_message_handler__choose_trello_list', lists=trello_lists_formatted),
            update
        )
        ...
        try:
            ...
            logger.warning(e)
            reply(load('user_message_handler__try_again'), update)
            return
        command_data[consts.GetTasksReportData.LIST_ID] = list_id

        reply_markup = telegram.InlineKeyboardMarkup(
            [[telegram.InlineKeyboardButton(
                load('user_message_handler__without_text_btn'),
                callback_data=ButtonValues.GET_TASKS_REPORT__NO_INTRO.value
            )]]
        )
        reply(load('user_message_handler__add_intro_text'), update, reply_markup=reply_markup)
        ...
        reply(
            load('user_message_handler__should_add_tags'),
        ...
        if button == ButtonValues.MANAGE_REMINDERS__ACTIONS__NEW:
            reply(load('user_message_handler__send_chat_id'), update)
            ...
            reply(load('user_message_handler__reminder_id_to_delete'), update)
            set_next_action(
            ...
            reply(load('user_message_handler__reminder_id_to_edit'), update)
            set_next_action(
                command_data, PlainTextUserAction.MANAGE_REMINDERS__ENTER_REMINDER_NUMBER
            )
        ...
        try:
            ...
            reply(load('user_message_handler__reminder_id_bad'), update)
            return
        ...
        if action == ButtonValues.MANAGE_REMINDERS__ACTIONS__DELETE:
            ...
            reply(
                load(
                    'user_message_handler__confirm_delete',
                    chat=chat_title,
            ...
            reply(
                load(
                    'user_message_handler__weekly_reminder',
                    weekday=weekday_str,
                    time=reminder.time,
                    text=reminder.text,
                ),
        ...
        if button == ButtonValues.MANAGE_REMINDERS__EDIT__TEXT:
            reply(load('user_message_handler__prompt_reminder_text'), update)
            ...
            reply(
                load('user_message_handler__prompt_rename_reminder', old_name=reminder.name),
                update
            )
            ...
            reply(
                load('user_message_handler__prompt_chat_id', name=reminder.name),
                update
            )
            set_next_action(command_data, PlainTextUserAction.MANAGE_REMINDERS__ENTER_CHAT_ID)
            return
            ...
            reply(
                load('user_message_handler__prompt_weekday'),
                update,
                reply_markup=reply_markup
            )
            ...
            if reminder.is_active:
                ...
                reply(
                    load('user_message_handler__reminder_was_suspended', name=reminder.name),
                    update
                )
            else:
                ...
                reply(
                    load(
                        'user_message_handler__reminder_was_resumed',
        ...
        if button == ButtonValues.MANAGE_REMINDERS__DELETE__YES:
            ...
            reply(load('user_message_handler__reminder_was_deleted'), update)
            set_next_action(command_data, None)
        elif button == ButtonValues.MANAGE_REMINDERS__DELETE__NO:
            reply(load('user_message_handler__reminder_was_not_deleted'), update)
            set_next_action(command_data, None)
        return
        ...
        try:
            ...
            reply(load('user_message_handler__prompt_check_id'), update)
            logger.info(e)
            return
        ...
        if action == ButtonValues.MANAGE_REMINDERS__ACTIONS__NEW:
            reply(
                load('user_message_handler__prompt_enter_reminder_title', chat_title=chat_title),
                update
            )
            set_next_action(command_data, PlainTextUserAction.MANAGE_REMINDERS__ENTER_NAME)
        elif action == ButtonValues.MANAGE_REMINDERS__ACTIONS__EDIT:
            ...
            reply(
                load(
                    'user_message_handler__reminder_set',
                    name=reminder.name,
        ...
        if action == ButtonValues.MANAGE_REMINDERS__ACTIONS__NEW:
            ...
            reply(load('user_message_handler__reminder_name_was_changed'), update)
            set_next_action(command_data, None)
        return
        ...
        if action == ButtonValues.MANAGE_REMINDERS__ACTIONS__NEW:
            ...
            reply(load('user_message_handler__reminder_text_was_changed'), update)
            set_next_action(command_data, None)
        return
        ...
        reply(
            load('user_message_handler__prompt_time', weekday_name=weekday_name),
            update
        )
        return
        ...
        try:
            ...
            reply(
                load('user_message_handler__prompt_time_bad'),
                update
            )
            return
        ...
        set_next_action(command_data, None)
        reply(
            load('user_message_handler__success_time', weekday_name=weekday_name, time=time),
            update
        )
    else:
